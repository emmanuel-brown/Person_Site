...
const Footer = () =>{
    return(
        <section id="footer">
            <Box name="Github" username="Sall.star01" animation={true} isLeft={true} imageSize="100em" logo="https://icon-library.net/images/github-icon-png/github-icon-png-29.jpg"/>
